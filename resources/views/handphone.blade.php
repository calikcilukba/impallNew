                ...
                <div class="row">
                    <div class="col-md-12">
                            <div class="panel">
                                ...
                                @endif
                                    <form action="searchhand" method="get">
                                        <div class="center">
                                    ...
                                    <div class="panel-heading">
                                        <a href="/handphone"><h3 class="panel-title">Data Produk Handphone</h3></a>
                                        <div class="right">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                ...
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Tambah Produk handphone</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>

                                                        <form method="POST" action="/handphone/create" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <form method="POST" action="{{ action('controllerproduct@updateh','test') }}" enctype="multipart/form-data" id="ediform">
                                                            <div class="modal-body">
                                                            @csrf
                                                            {{method_field('patch')}}
